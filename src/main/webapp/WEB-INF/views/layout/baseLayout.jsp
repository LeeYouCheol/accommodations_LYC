...
<link rel="stylesheet" href="<c:url value="/resources/css/tiny-slider.css"></c:url>">
...
<body>
		...
		<div class="container">
			<div class="menu-bg-wrap">
				<div class="site-navigation">
					<a href="index.html" class="logo m-0 float-start">모여라고시원</a>

					<ul class="js-clone-nav d-none d-lg-inline-block text-start site-menu float-end">
						<li><a href="index.html">Home</a></li>
						<li class="has-children">
							<a href="properties.html">고시원</a>
							<ul class="dropdown">
								<li><a href="#">고시원찾기</a></li>
	...
	<div class="hero page-inner overlay" style="background-image: url('<c:url value="/resources/images/hero_bg_3.jpg"></c:url>');">
			...
			<div class="row justify-content-between mb-5">
				<div class="col-lg-7 mb-5 mb-lg-0 order-lg-2">
					<div class="img-about dots">
						<img src="<c:url value="/resources/images/hero_bg_3.jpg"></c:url>" alt="Image" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-4">
		...
		<div class="container">
			<div class="row justify-content-between mb-5">
				<div class="col-lg-7 mb-5 mb-lg-0">
					<div class="img-about dots">
						<img src="<c:url value="/resources/images/hero_bg_2.jpg"></c:url>" alt="Image" class="img-fluid">
					</div>
				</div>
				<div class="col-lg-4">
					<div class="d-flex feature-h">
		...
		<div class="container">
			<div class="row">
				<div class="col-md-4" data-aos="fade-up" data-aos-delay="0">
					<img src="<c:url value="/resources/images/img_1.jpg"></c:url>" alt="Image" class="img-fluid">
				</div>
				<div class="col-md-4 mt-lg-5" data-aos="fade-up" data-aos-delay="100">
					<img src="<c:url value="/resources/images/img_3.jpg"></c:url>" alt="Image" class="img-fluid">
				</div>
				<div class="col-md-4" data-aos="fade-up" data-aos-delay="200">
					<img src="<c:url value="/resources/images/img_2.jpg"></c:url>" alt="Image" class="img-fluid">
				</div>
			</div>
				...
				<div class="testimonial-slider">
					<div class="item">
						<div class="testimonial">
							<img src="<c:url value="/resources/images/person_1-min.jpg"></c:url>" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
					...
					<div class="item">
						<div class="testimonial">
							<img src="<c:url value="/resources/images/person_2-min.jpg"></c:url>" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
					...
					<div class="item">
						<div class="testimonial">
							<img src="<c:url value="/resources/images/person_3-min.jpg"></c:url>" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
					...
					<div class="item">
						<div class="testimonial">
							<img src="<c:url value="/resources/images/person_4.jpg"></c:url>" alt="Image" class="img-fluid rounded-circle w-25 mb-4">
    ...
    <script src="<c:url value="/resources/js/tiny-slider.js"></c:url>"></script>
    <script src="<c:url value="/resources/js/aos.js"></c:url>"></script>
    <script src="<c:url value="/resources/js/navbar.js"></c:url>"></script>
    <script src="<c:url value="/resources/js/counter.js"></c:url>"></script>
