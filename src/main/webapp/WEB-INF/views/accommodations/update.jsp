...
<div class="untree_co-section bg-light">
	<div class="container">
		<div class="row justify-content-center text-center mb-5">
			<div class="col-lg-6">
				<h2 class="text-secondary heading-2">고시원 수정</h2>
			</div>
		</div>
			...
			<div class="col-lg-9 bg-white p-5">
				<form class="contact-form" data-aos="fade-up" data-aos-delay="200" action="<c:url value="/accommodations/insert"></c:url>" method="post" enctype="multipart/form-data">
					<div class="form-group">
						...
						<input type="text" class="form-control" value="${accommodations.ac_name}">
					</div>
					<div style="display:flex">
						<div class="form-group" style="display:flex">
							<label for="ac_representation" style="line-height: 45px;">대표자:</label>
							<input type="text" class="form-control" value="${accommodations.ac_representation}" style="width:45%;" readonly>
						</div>
						<div class="form-group" style="display:flex">
							<label for="ac_me_id" style="line-height: 45px;">아이디:</label>
							<input type="text" class="form-control" value="${accommodations.ac_me_id}" style="width:45%;" readonly>
						</div>
					</div>
					<div class="form-group">
						<label>주소:</label>
						<div class="input-group mb-3">
							<input type="text" id="ac_post_code" placeholder="우편번호" name="ac_post_code" id="ac_post_code" value="${accommodations.ac_post_code}" class="form-control">
							<input type="button" onclick="execDaumPostcode()" value="우편번호 찾기" class="form-control">
					  	</div>
						<div class="input-group mb-3">
							<input type="text" id="ac_addr" placeholder="주소" name="ac_addr" id="ac_addr" value="${accommodations.ac_addr}" class="form-control">
						</div>
						<div class="input-group mb-3">
							<input type="text" id="ac_addr_detail" placeholder="상세주소" name="ac_addr_detail" id="ac_addr_detail" value="${accommodations.ac_addr_detail}" class="form-control">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="floor" style="display:flex;">
						<div class="form-group" style="display:flex;">
							...
							<input type="text" class="form-control" id="ac_floor" name="ac_floor" value="${accommodations.ac_floor}" placeholder="숫자" style="width:50%;">
						</div>
						<div class="form-group" style="display:flex;">
							<label for="ac_to_room" style="line-height: 45px;">객실수:</label>
							<input type="text" class="form-control" id="ac_to_room" name="ac_to_room" value="${accommodations.ac_to_room}" placeholder="숫자" style="width:50%;">
						</div>
					</div>
					<div class="form-group">
						<label>층별안내도:</label>
					...
					<div class="form-group">
						...
						<textarea class="form-control" id="ac_content" name="ac_content">${accommodations.ac_content}</textarea>
					</div>
					<button class="btn btn-outline-primary float-right mt-4">수정</button>
				</form>
			</div>
		</div>
	</div>
