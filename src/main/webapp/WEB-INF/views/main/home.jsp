    ...
    <div class="row align-items-stretch">
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="untree_co-testimonial h-100">
          ...
          <div class="author d-flex align-items-center">
            <div class="author-picture mr-3"><img src="<c:url value="/resources/images/person_1.jpg"></c:url>" alt="Image" class="img-fluid"></div>
      ...
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="untree_co-testimonial h-100">
          ...
          <div class="author d-flex align-items-center">
            <div class="author-picture mr-3"><img src="<c:url value="/resources/images/person_2.jpg"></c:url>" alt="Image" class="img-fluid"></div>
            <div class="author-name">
              <strong class="d-block">John Smith</strong>
              <span>CTO &mdash; Slack, Inc.</span>
            </div>
      ...
      <div class="col-lg-4 mb-4 mb-lg-0">
        <div class="untree_co-testimonial h-100">
          ...
          <div class="author d-flex align-items-center">
            <div class="author-picture mr-3"><img src="<c:url value="/resources/images/person_3.jpg"></c:url>" alt="Image" class="img-fluid"></div>
            <div class="author-name">
              <strong class="d-block">John Smith</strong>
              <span>CTO &mdash; Slack, Inc.</span>
            </div>
