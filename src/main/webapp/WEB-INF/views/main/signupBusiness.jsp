    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 bg-white p-5">
          <form class="contact-form" data-aos="fade-up" data-aos-delay="200" action="<%=request.getContextPath()%>/signup/business" method="post" id="signup">
            <div class="row">
              <div class="col-12">
            ...
            <div class="form-group">
              <label class="text-black" for="bm_number">사업자등록번호</label>
              <input type="text" class="form-control" id="bm_number" name="bm_number" placeholder="xxx-xx-xxxx-x형태로입력하세요">
            </div>
            <div class="form-group">
